...
-   **** : solo solicitudes del sistema en el que está
    Jeedom instalado están permitidos,

-   **** : sin restricciones, cualquier sistema con acceso
...
-   **Base de datos** : Permite el acceso a la base de datos
    ...
    -   **** : Nombre de usuario utilizado por Jeedom en
        la base de datos,
...
> de abajo.  : los registros serán muy detallados !
...
-   **** : Hay 4 niveles de correspondencia (sensibilidad
...
-   **Regex de exclusión general para interacciones** : permite
     ...
     **Exclusión de expresiones regulares** documentación sobre
    interacciones.

Interacción automática, contextual y advertencia 
-----------------------------------------------------

-    **interacciones automáticas** permitir que Jeedom intente
...
-    **interacciones contextuales** permitirte encadenar
...
>  : **Comando de retorno predeterminado**.
...
-   **Sinónimo de objetos** : Lista de sinónimos para objetos
    ( : rdc|planta baja|bajo tierra|bajo; sdb|Cuarto de baño).
...
-   **Agregar un mensaje a cada tiempo de espera** : Agregue un mensaje en el
    centro de mensajes si el equipo cae en ****.

-   **Orden de tiempo de espera** : Comando de tipo **** a utilizar
    si hay un equipo en ****.
...
-   **Comando de batería en Advertencia** : Comando de tipo ****
    para ser usado si el equipo tiene el nivel de batería ****.

-   **Agregue un mensaje a cada batería en peligro** : Añadir un
    mensaje en el centro de mensajes si un dispositivo tiene su nivel de
    batería en ****.

-   **Comando con batería en peligro** : Comando de tipo **** para
    úselo si el equipo tiene el nivel de batería ****.

-   **Agregue un mensaje a cada Advertencia** : Agregue un mensaje en el
    centro de mensajes si un pedido entra en alerta ****.

-   **Comando de advertencia** : Comando de tipo **** a utilizar
    si un pedido se pone en alerta ****.

-   **Agregue un mensaje a cada peligro** : Agregue un mensaje en el
    centro de mensajes si un pedido entra en alerta ****.

-   **Comando en peligro** : Comando de tipo **** usar si
    una orden se pone en alerta ****.
...
para usar este repositorio.  : cualquier solicitud de soporte puede ser
