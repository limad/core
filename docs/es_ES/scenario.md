...
| (#time#, -90)               | si son las 4:50 p.m., regrese : 1 650-1 130 = 1520                          |
...
-   **** (variable) : Creación / modificación de una variable o valor
    de una variable.

-   **Eliminar variable** () : Le permite eliminar una variable
...
-   **Eliminar bloque IN / A programado** () : Le permite eliminar el
