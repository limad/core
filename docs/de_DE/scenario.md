...
-   **** : Der für das Szenario gewünschte Protokolltyp.
...
| averageBetween(\.#[Salle de bain][Hydrometrie][Humidité]\.#,:00::00:00) | Gibt die durchschnittliche Bestellung zwischen dem 1. Januar 2015 und dem 15. Januar 2015 zurück                         |
| min (Fang, Zeitraum)                 | Gibt 0 zurück : Der Stecker wurde während des Zeitraums gelöscht              |
| minBetween(\.#[Salle de bain][Hydrometrie][Humidité]\.#,:00::00:00) | Gibt die Mindestbestellmenge zwischen dem 1. Januar 2015 und dem 15. Januar 2015 zurück                         |
| max (Fang, Zeitraum)                 | Rückgabe 1 : Der Stecker war in der Zeit gut beleuchtet              |
| maxBetween(\.#[Salle de bain][Hydrometrie][Humidité]\.#,:00::00:00) | Gibt das Maximum der Bestellung zwischen dem 1. Januar 2015 und dem 15. Januar 2015 zurück                         |
...
-   **** (alert) : Ermöglicht das Anzeigen einer kleinen Warnmeldung für alle
...
-   **Programmierten IN / A-Block löschen** () : Ermöglicht das Löschen der
